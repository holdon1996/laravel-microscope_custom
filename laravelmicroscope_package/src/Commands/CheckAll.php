...
class CheckAll extends Command
{
    ...
    protected $signature = 'check:all {--d|detailed : Show files being checked} {--f|force} {--s|nofix : avoids the automatic fixes} {--folder= : Check directory}';
    ...
    public function handle(ErrorPrinter $errorPrinter)
    {
        ...
        $this->call('check:imports', ['--nofix' => $this->option('nofix'), '--detailed' => $this->option('detailed'), '--folder' => $this->option('folder')]);
